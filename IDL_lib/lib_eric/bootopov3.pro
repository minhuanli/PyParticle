pro bootopov3,data,fname,r01=r01,c1=c1,c2=c2,c3=c3,camera=camera,noclip=noclip
tm=max(data(15,*))
tmin=min(data(15,*))
...
ra=fltarr(1,n1)
ca=fltarr(3,n1)+255
w1=where(a2(3,*) lt 7.0 and a2(5,*) ge 0.27 and a2(14,*) gt 13,nna)
;if nna gt 0 then begin
;if keyword_set(r01) then begin
;ra(0,w1)=r01[0]
;endif else begin
ra(0,w1)=1.85
;endelse
...
w2=where(a2(5,*) ge 0.27 and a2(3,*) lt 7.0 and a2(14,*) lt 13,nac)
...
b0y=b002(10,*)+0.2
b0z=b0y/b0x
w13=where(b0x gt 0 and b0z lt 0.4/0.15,ncd)

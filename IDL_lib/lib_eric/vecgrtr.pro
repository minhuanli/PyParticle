function vecgrtr,evc,pos,deltar=deltar,bins=bins
s=size(evc)
s1=s[1]/2
...
vecgr01(j,i)=(evc01(0,j)*(pos(0,j)-pos(0,i))+evc01(1,j)*(pos(1,j)-pos(1,i)))*(evc01(0,i)*(pos(0,j)-pos(0,i))+evc01(1,i)*(pos(1,j)-pos(1,i)))/((pos(0,j)-pos(0,i))^2+(pos(1,j)-pos(1,i))^2)

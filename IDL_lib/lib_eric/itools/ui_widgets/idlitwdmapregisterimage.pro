; $Id: //depot/idl/IDL_71/idldir/lib/itools/ui_widgets/idlitwdmapregisterimage.pro#1 $
...
pro IDLitwdMapRegisterImage_1_docreate, pState, id
    ...
    if(IDLitGetResource("itools_about", img, background=background))then begin
        idims = SIZE(img, /DIMENSIONS)
        wDraw = WIDGET_DRAW(wRow, $
            xsize=idims[0], ysize=idims[1], retain=2)

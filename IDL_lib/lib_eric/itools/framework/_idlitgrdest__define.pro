; $Id: //depot/idl/IDL_71/idldir/lib/itools/framework/_idlitgrdest__define.pro#1 $
;
...
pro _IDLitgrDest::_RegisterProperties, $
    ...
    if (registerAll || (updateFromVersion lt 610)) then begin
        self->RegisterProperty, 'CURRENT_ZOOM', /FLOAT, /HIDE
        ...
        self->RegisterProperty, 'VISIBLE_LOCATION', USERDEF='', /HIDE, $
            ...
            DESCRIPTION='Location of visible portion of window'

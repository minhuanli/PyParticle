; $Id: //depot/idl/IDL_71/idldir/lib/itools/framework/idlitsrvcreatevisualization__define.pro#1 $
;
   ...
   for i=0, nVis-1 do begin
    ...
    if (nVis eq 1 && OBJ_ISA(oVis, 'IDLitVisImage')) then begin
      ...
      if (OBJ_VALID(oDesc)) then begin
        ...
        if (toolName eq 'Map Tool' || N_tags(sProj) gt 0) then begin
            ...
            if (OBJ_ISA(oData[0], "IDLitParameterSet")) then begin

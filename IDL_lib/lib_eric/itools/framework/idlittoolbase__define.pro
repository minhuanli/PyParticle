; $Id: //depot/idl/IDL_71/idldir/lib/itools/framework/idlittoolbase__define.pro#1 $
;
...
;         IDENTIFIER='Window/Tool Browser'; , ICON='mcr'
    ...
    DEFSYSV, '!IDLDT_TempFilepath', EXISTS=isWorkbench
    if (isWorkbench) then begin
    ...
    self->RegisterOperation, IDLitLangCatQuery('Menu:Help:AboutiTools'), $
        'IDLitopHelpAbout', $
        IDENTIFIER='Help/About iTools', /SEPARATOR

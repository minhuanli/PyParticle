; $Id: //depot/idl/IDL_71/idldir/lib/itools/framework/_idlitmanipulator__define.pro#1 $
;
...
pro _IDLitManipulator::OnMouseDown, oWin, x, y, iButton, KeyMods, nClicks, $
   ...
   if (~KEYWORD_SET(noSelect)) then $
       self->_Select, oWin, x, y , iButton, KeyMods, nClicks
...
;
pro _IDLitManipulator::SetCurrentManipulator, Item

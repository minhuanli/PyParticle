; $Id: //depot/idl/IDL_71/idldir/lib/itools/components/idlitvisvolume__define.pro#1 $
;
...
pro IDLitVisVolume::_RegisterProperties, $
    ...
    if (registerAll || (updateFromVersion lt 610)) then begin
        ...
        self->RegisterProperty, '_RENDER_QUALITY', $
            ...
            NAME='Quality', $
            DESCRIPTION='Volume rendering quality'

        self->RegisterProperty, 'RENDER_EXTENTS', $
            ENUMLIST=['Off', 'Wire frame', 'Solid walls'], $
            NAME='Boundary', $
            DESCRIPTION='Render the volume boundary'
        ...
        self->RegisterProperty, 'X_RENDER_STEP', /FLOAT, $
            NAME='Render step X', $
            DESCRIPTION='X stepping factor through the voxel matrix'

        self->RegisterProperty, 'Y_RENDER_STEP', /FLOAT, $
            NAME='Render step Y', $
            DESCRIPTION='Y stepping factor through the voxel matrix'

        self->RegisterProperty, 'Z_RENDER_STEP', /FLOAT, $
            NAME='Render step Z', $
        ...
        self->RegisterProperty, 'BYTESCALE_MIN', $
            ...
            DESCRIPTION='Display scale bottom', /HIDE

        self->RegisterProperty, 'BYTESCALE_MAX', $
            NAME='Byte Scale Max', $
            USERDEF='Display scale top', $
            DESCRIPTION='Display scale top', /HIDE
...
pro IDLitVisVolume::GetProperty, $
  ...
  compile_opt idl2, hidden
    ...
    if ARG_PRESENT(extentsTransparency) then begin
        ...
        extentsTransparency = 0 > FIX(100 - alpha*100) < 100
    endif

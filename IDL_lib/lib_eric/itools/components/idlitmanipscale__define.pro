; $Id: //depot/idl/IDL_71/idldir/lib/itools/components/idlitmanipscale__define.pro#1 $
;
...
pro IDLitManipScale::_Scale, oWin, x, y, KeyMods
    ...
    if ((KeyMods and 1) or self.is3D) then begin
...
PRO IDLitManipScale::SetCurrentManipulator, type
    ...
    ; Call our superclass.
    self->IDLitManipulator::SetCurrentManipulator, type
end

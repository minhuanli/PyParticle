; $Id: //depot/idl/IDL_71/idldir/lib/itools/components/idlitopcommandlinefocus__define.pro#1 $
;
...
function IDLitopCommandLineFocus::DoAction, oTool
  ...
  void = IDLNotify('IDLWorkbenchFocus','com.rsi.idldt.ui.views.CommandLineView')

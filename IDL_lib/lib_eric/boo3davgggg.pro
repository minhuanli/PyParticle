...
function boo3davgggg,tr,deltar=deltar,bondmax=bondmax
pos=tr(0:2,*)
n1=n_elements(pos(0,*))
bo01=fltarr(13,n1)
...
;qiqj01=(qqa1(0,i)*(qqa1(0,w1)))+(qqa1(1,i)*(qqa1(1,w1)))+(qqa1(2,i)*(qqa1(2,w1)))+(qqa1(3,i)*(qqa1(3,w1)))+(qqa1(4,i)*(qqa1(4,w1)))+(qqa1(5,i)*(qqa1(5,w1)))+(qqa1(6,i)*(qqa1(6,w1)))+(qqa1(7,i)*(qqa1(7,w1)))+(qqa1(8,i)*(qqa1(8,w1)))+(qqa1(9,i)*(qqa1(9,w1)))+(qqa1(10,i)*(qqa1(10,w1)))+(qqa1(11,i)*(qqa1(11,w1)))+(qqa1(12,i)*(qqa1(12,w1)))
;qiqj02=abs(qiqj01)/(qlm1*qlmw)
;qiqj01=abs(qqa1(0,i)*conj(qqa1(0,w1)))+abs(qqa1(1,i)*conj(qqa1(1,w1)))+abs(qqa1(2,i)*conj(qqa1(2,w1)))+abs(qqa1(3,i)*conj(qqa1(3,w1)))+abs(qqa1(4,i)*conj(qqa1(4,w1)))+abs(qqa1(5,i)*conj(qqa1(5,w1)))+abs(qqa1(6,i)*conj(qqa1(6,w1)))+abs(qqa1(7,i)*conj(qqa1(7,w1)))+abs(qqa1(8,i)*conj(qqa1(8,w1)))+abs(qqa1(9,i)*conj(qqa1(9,w1)))+abs(qqa1(10,i)*conj(qqa1(10,w1)))+abs(qqa1(11,i)*conj(qqa1(11,w1)))+abs(qqa1(12,i)*conj(qqa1(12,w1)))
;qiqj02=abs(qiqj01)
...
;wa=where(qiqj02(0,*) gt 0.35,ncountj)
;wb=where(qiqj02(0,*) le 0.35,ncountjj)
;bo01(0,i)=mean(qiqj01)
bo01(0,i)=ncountj
...
if ncountj lt 7.0 and wb[0] eq -1 then begin
qqc1=qqa1(0,w1)
qqcc1=(total(qqc1(0,wa))+qqa1(0,i))/(1.0+ncountj)
qqc2=qqa1(1,w1)
qqcc2=(total(qqc2(0,wa))+qqa1(1,i))/(1.0+ncountj)

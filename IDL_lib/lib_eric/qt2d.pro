...
function qt2d, xyt, a, mydts=mydts
...
n_p=round(n_elements(xyt(0,*))/(max(xyt(5,*))-min(xyt(5,*))+1))
volumn=(max(xyt(0,*))-min(xyt(0,*)))*(max(xyt(1,*))-min(xyt(1,*)))
qchi(2,*)=qchi(2,*)*volumn/n_p/n_p
return, qchi
end

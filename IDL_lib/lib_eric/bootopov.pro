pro bootopov,data,fname,r1=r1,c1=c1,c2=c2,c3=c3,camera=camera,noclip=noclip
tm=max(data(15,*))
tmin=min(data(15,*))
...
;endelse
;endif
w2=where(a2(3,*) lt 7.0 and a2(5,*) gt 0.27,na)
if na gt 0 then begin
if keyword_set(r1) then begin
ra(0,w2)=r1[1]
endif else begin
...
;endelse
;endif
w3=where(a2(3,*) lt 7.0 and a2(5,*) le 0.27,na)
if na gt 0 then begin
if keyword_set(r1) then begin
ra(0,w3)=r1[0]
endif else begin

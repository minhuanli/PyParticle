pro bootopov1,data,fname,r1=r1,c1=c1,c2=c2,c3=c3,camera=camera,noclip=noclip
tm=max(data(15,*))
tmin=min(data(15,*))
...
ra=fltarr(1,n1)
ca=fltarr(3,n1)
w1=where(a2(3,*) ge 7.0 and a2(14,*) gt 13,na)
...
;endelse
;endif
w2=where(a2(3,*) ge 7.0 and a2(14,*) lt 13,na)
if na gt 0 then begin
b002=a2(*,w2)
b0x=b002(8,*)-0.1
b0y=b002(10,*)+0.2

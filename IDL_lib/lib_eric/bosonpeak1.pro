function bosonpeak1,evc01,evs01,trb
omg01=1./sqrt(abs(evs01))
n0=n_elements(evs01)/2
ra01=findgen(4,2.0*n0)
p01=mobility(trb)
p06=p01(2,*)
p05=p01(0:1,*)
...
n002=n_elements(evc002(0,*))
nn01=total((evc02(0,w))^2+(evc02(1,w))^2)
nn02=1.*n_elements(evc02(0,w))/n0
nn03=nn01*(1-nn02)/(nn02*(1-nn01))
nn001=total((evc002(0,w1))^2+(evc002(1,w1))^2)
nn002=1.*n_elements(evc002(0,w1))
nn003=nn001*(n002-nn002)/(nn002*(n2-nn001))
ra01(1,j)=nn03
ra01(2,j)=nn003
ra01(3,j)=nn002
end

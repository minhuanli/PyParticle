...
function boo3davggaa,tr,deltar=deltar,bondmax=bondmax
pos=tr(0:2,*)
n1=n_elements(pos(0,*))
bo01=fltarr(13,n1)
...
w11=a2a[1:bondmax]
a3=a2(0,w11)
w12=where(a3 gt 0. and a3 le deltar^2,nddd)
...
bo01(0,i)=ncountj
if ncountj ge 0.0 then begin
qqc1=qqa1(0,w1)
qqcc1=(total(qqc1(0,*))+qqa1(0,i))/(1.0+nddd)
qqc2=qqa1(1,w1)
qqcc2=(total(qqc2(0,*))+qqa1(1,i))/(1.0+nddd)
qqc3=qqa1(2,w1)
qqcc3=(total(qqc3(0,*))+qqa1(2,i))/(1.0+nddd)
qqc4=qqa1(3,w1)
qqcc4=(total(qqc4(0,*))+qqa1(3,i))/(1.0+nddd)
qqc5=qqa1(4,w1)
qqcc5=(total(qqc5(0,*))+qqa1(4,i))/(1.0+nddd)
qqc6=qqa1(5,w1)
qqcc6=(total(qqc6(0,*))+qqa1(5,i))/(1.0+nddd)
qqc7=qqa1(6,w1)
qqcc7=(total(qqc7(0,*))+qqa1(6,i))/(1.0+nddd)
qqc8=qqa1(7,w1)
qqcc8=(total(qqc8(0,*))+qqa1(7,i))/(1.0+nddd)
qqc9=qqa1(8,w1)
qqcc9=(total(qqc9(0,*))+qqa1(8,i))/(1.0+nddd)
qqc10=qqa1(9,w1)
qqcc10=(total(qqc10(0,*))+qqa1(9,i))/(1.0+nddd)
qqc11=qqa1(10,w1)
qqcc11=(total(qqc11(0,*))+qqa1(10,i))/(1.0+nddd)
qqc12=qqa1(11,w1)
qqcc12=(total(qqc12(0,*))+qqa1(11,i))/(1.0+nddd)
qqc13=qqa1(12,w1)
qqcc13=(total(qqc13(0,*))+qqa1(12,i))/(1.0+nddd)
qqd1=qqb1(0,w1)
qqdd1=(total(qqd1(0,*))+qqb1(0,i))/(1.0+nddd)
qqd2=qqb1(1,w1)
qqdd2=(total(qqd2(0,*))+qqb1(1,i))/(1.0+nddd)
qqd3=qqb1(2,w1)
qqdd3=(total(qqd3(0,*))+qqb1(2,i))/(1.0+nddd)
qqd4=qqb1(3,w1)
qqdd4=(total(qqd4(0,*))+qqb1(3,i))/(1.0+nddd)
qqd5=qqb1(4,w1)
qqdd5=(total(qqd5(0,*))+qqb1(4,i))/(1.0+nddd)
qqd6=qqb1(5,w1)
qqdd6=(total(qqd6(0,*))+qqb1(5,i))/(1.0+nddd)
qqd7=qqb1(6,w1)
qqdd7=(total(qqd7(0,*))+qqb1(6,i))/(1.0+nddd)
qqd8=qqb1(7,w1)
qqdd8=(total(qqd8(0,*))+qqb1(7,i))/(1.0+nddd)
qqd9=qqb1(8,w1)
qqdd9=(total(qqd9(0,*))+qqb1(8,i))/(1.0+nddd)

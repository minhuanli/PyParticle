;----------------------------------------------------------------
; $Id: //depot/idl/IDL_71/idldir/lib/wavelet/source/wv_fn_morlet.pro#1 $
;
...
;----------------------------------------------------------------
FUNCTION wv_fn_morlet, orderInput, scaleInput, nInput, $
    DOUBLE=double, $
    FREQUENCY=frequency, $
    SPATIAL=spatial, $
    WAVELET=wavelet
...
;defaults
    order_range = [3d,24d,6d]  ; [first,last,default]

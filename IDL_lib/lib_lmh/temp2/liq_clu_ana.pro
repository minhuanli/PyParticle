...
for i = 1 ,5 do begin 
   ...
   print, 'now ' + 'pos : ' + string(i) + 'time: ' + string(t)
     ...
     w = where(boo(5,*) lt 0.34, nw) ; pick out liquid
     ...
     write_gdf,res,'D:\liminhuan\s-s transition project\paper figure\figure1\cluster_analysis_liq\liqclu_pos'+string(i)+' t_'+ string(t)+'.gdf'  

...
pro lifetime1_pre,series,liqt = liqt, bcclt=bcclt,hcplt=hcplt,fcclt=fcclt,dc=dc
...
;===============================================================================
pro lifetimeall_pre,dataall,idlist,liqta=liqta,bcclta=bcclta,hcplta=hcplta,fcclta=fcclta,dc=dc
liqta = [-1.]
bcclta= [-1.]
hcplta=[-1.]
fcclta=[-1.]
...
for i = 0, nid -1 do begin
  ...
  lifetime1_pre,seriesi,liqt = liqti, bcclt=bcclti,hcplt=hcplti,fcclt=fcclti,dc=dc
  liqta = [[liqta],[liqti]]

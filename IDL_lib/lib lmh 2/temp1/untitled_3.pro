print,'pos2'
file = file_search('D:\liminhuan\data-m1\mf001-boo\voiboom1-mf001-p       2_time-*')
for i = 0,12 do begin
  boo = read_gdf(file(i))
  zmax = max(boo(2,*))
  zmin = min(boo(2,*))
  ...
  saveimage, 0, [800,800], 'D:\liminhuan\s-s transition project\mf001 p2 low\m1p2spbcclow time'+string(i)+'.png', type=4
...
;  saveimage, 0, [800,800], 'D:\liminhuan\s-s transition project\mf001 p4 mid\m1p4solidmid time'+string(i)+'.png', type=4
;  
;  ; mid bcc slice
;  window,0,xsize=800,ysize=800
;  ;test0 = polycut(blowc,f1=0,f2=2)
;  w=where(test1(5,*) gt 0.35 and test1(8,*) gt 0)
;  plot,test1(0,w),test1(1,w),psym=8,backgr='ffffff'x,color='000000'x,/iso,symsize=0.75
;  saveimage, 0, [800,800], 'D:\liminhuan\s-s transition project\mf001 p4 mid\m1p4bccmid time'+string(i)+'.png', type=4
